...
async function seed() {
  ...
  const permissionDefs = [
    { code: 'customer:read', name: '查看客户', resource: 'customer', action: 'view' },
    ...
    { code: 'opportunity:read', name: '查看商机', resource: 'opportunity', action: 'view' },
    ...
    { code: 'contract:read', name: '查看合同', resource: 'contract', action: 'view' },
    ...
    { code: 'project:read', name: '查看项目', resource: 'project', action: 'view' },
    ...
    { code: 'product:read', name: '查看产品', resource: 'product', action: 'view' },
    ...
    { code: 'commission:read', name: '查看提成', resource: 'commission', action: 'view' },
    ...
    { code: 'user:read', name: '查看用户', resource: 'user', action: 'view' },
    ...
    { code: 'finance:read', name: '查看财务', resource: 'finance', action: 'view' },
  ...
  const roleDefs = [
    ...
    { id: roleIds.salesMember, name: '销售成员', code: 'sales_member', isSystem: true, allPerms: false, perms: ['customer:read','customer:create','customer:edit','opportunity:read','opportunity:create','opportunity:edit','contract:read','contract:create','project:read','product:read'] },
    { id: roleIds.finance, name: '财务', code: 'finance', isSystem: true, allPerms: false, perms: ['contract:read','contract:approve','commission:read','commission:approve','commission:adjust','commission:manage','finance:read','finance:manage','customer:read','opportunity:read','project:read','product:read'] },
  ]
