  ...
  const groups: SidebarGroup[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: '库存', icon: 'i-lucide-package', to: '/dashboard/inventory', sort: configSort('inventory') !== 99 ? configSort('inventory') : 3, hidden: !can('inventory:read') },
        { label: '仓库', icon: 'i-lucide-warehouse', to: '/dashboard/warehouses', sort: configSort('warehouses') !== 99 ? configSort('warehouses') : 4, hidden: !can('warehouse:read') },
