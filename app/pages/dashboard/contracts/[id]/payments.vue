...
definePageMeta({ layout: 'dashboard', title: '收款记录', middleware: ['auth'], watermark: true })
...
<template>
  <div class="mb-4 flex items-center gap-2 text-sm">
    ...
    <span class="text-content-muted">/</span>
    <span class="text-content-primary">收款记录</span>
  </div>
  ...
  <div v-else>
    ...
    <ContractPayments :contract-id="contractId" @save="handleSave" />
  </div>
</template>
