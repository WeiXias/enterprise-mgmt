...
definePageMeta({ layout: 'dashboard', title: '产品明细', middleware: ['auth'], watermark: true })
...
<template>
  <div class="mb-4 flex items-center gap-2 text-sm">
    ...
    <span class="text-content-muted">/</span>
    <span class="text-content-primary">产品明细</span>
  </div>
  ...
  <div v-else>
    ...
    <ContractProductEdit :contract-id="contractId" @save="handleSave" />
  </div>
</template>
