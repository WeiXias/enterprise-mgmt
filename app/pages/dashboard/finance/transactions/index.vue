...
<template>
  <div>
    ...
    <UModal v-model:open="showDeleteModal">
      ...
      <template #body><p class="text-sm text-stone-600">确定要删除这条记录吗？</p></template>
      <template #footer><div class="flex justify-end gap-2"><UButton variant="ghost" color="neutral" @click="showDeleteModal = false">再想想</UButton><UButton color="error" :loading="deleteLoading" @click="handleDelete">确认</UButton></div></template>
    </UModal>
  </div>
</template>
