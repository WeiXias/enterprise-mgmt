...
<template>
  <div>
    <div class="mb-6 flex items-center justify-between">
      <div>
        <h1 class="text-lg font-medium text-content-primary">应付账款</h1>
        <p class="text-sm text-content-muted mt-0.5">已收货的采购订单，默认账期30天</p>
      </div>
    ...
    <div class="flex flex-wrap items-center gap-3 mb-4">
      <div class="relative flex-1 min-w-[200px] max-w-xs">
        ...
        <input v-model="keyword" type="text" placeholder="搜供应商名、订单号..." class="w-full pl-9 input-base focus-ring transition-colors" @input="onSearchInput" />
      </div>
    ...
    <div v-else-if="items.length === 0" class="text-center py-12 text-content-muted">
      <UIcon name="i-lucide-credit-card" class="w-10 h-10 mx-auto mb-2 text-content-muted" />
