...
<template>
  <div>
    <div class="mb-6 flex items-center justify-between">
      <div>
        <h1 class="text-lg font-medium text-content-primary">应付账龄分析</h1>
        <p class="text-sm text-content-muted mt-0.5">看看还有哪些款没付</p>
      </div>
    ...
    <div v-else-if="data">
      <div class="grid grid-cols-3 gap-4 mb-6">
        <div class="em-card p-4 text-center">
          ...
          <p class="text-xs text-content-muted mt-1">总应付金额</p>
        </div>
        <div class="em-card p-4 text-center">
