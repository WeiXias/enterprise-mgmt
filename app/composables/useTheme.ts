...
const searchIndex: SearchItem[] = [
  ...
  { label: '合同中心', desc: '合同仪表盘与概览', to: '/dashboard/contracts/center', icon: 'i-lucide-layout-dashboard', group: '合同中心', keywords: ['合同中心', '合同仪表盘', '合同概览', '合同 KPI'] },
  { label: '合同列表', desc: '查看和审批合同', to: '/dashboard/contracts', icon: 'i-lucide-file-text', group: '合同中心', keywords: ['合同', 'contract', '签约', '协议', '审批'] },
  { label: '合同台账', desc: '合同回款财务台账', to: '/dashboard/contracts/ledger', icon: 'i-lucide-table', group: '合同中心', keywords: ['台账', '合同台账', 'ledger', '回款'] },
  { label: '模板管理', desc: '合同模板管理', to: '/dashboard/contracts/templates', icon: 'i-lucide-layers', group: '合同中心', keywords: ['模板', '合同模板', 'templates', '占位符'] },
